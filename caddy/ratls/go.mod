module github.com/Privasys/enclave-os-virtual/caddy/ratls

go 1.25.0

// RA-TLS v2: builds with stock Go (no TLS extension, no fork). The evidence
// exchange runs after the handshake over the RFC 8446 exporter (attest.go).
// Build with: xcaddy build --with github.com/Privasys/enclave-os-virtual/caddy/ratls=.
